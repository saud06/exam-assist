  ...
  <section class="content-header">
    <h5>
      <ol class="breadcrumb">
        ...
        <li class="active"><?php echo $this->lang->line('header_edit_exam'); ?></li>
      </ol>
    </h5>
  </section>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title"><?php echo $this->lang->line('header_edit_exam'); ?></h3>
          </div>

          <!-- /.box-header -->
          <div class="box-body">
            <div class="row">
              <form role="form" id="form" method="post" action="<?php echo base_url('exam/edit_exam');?>" encType="multipart/form-data">
                <?php
                  foreach($data as $row){
                ?>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control select2" id="academic_year" name="academic_year" style="width: 100%">
                        ...
                        <option value="2022(Jan) - 2022(Dec)" <?php echo $row->academic_year === '2022(Jan) - 2022(Dec)' ? 'selected' : ''; ?>>2022(Jan) - 2022(Dec)</option>
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" id="class" name="class" style="width: 100%">
                        <option value="">Select</option>
                        <option value="IX" <?php echo $row->class_name === 'IX' ? 'selected' : ''; ?>>IX</option>
                        <option value="X" <?php echo $row->class_name === 'X' ? 'selected' : ''; ?>>X</option>
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" id="section" name="section" style="width: 100%">
                        <option value="">Select</option>
                        <option value="A-Science" <?php echo $row->section_name === 'A-Science' ? 'selected' : ''; ?>>A-Science</option>
                      </select>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control select2" id="exam_type" name="exam_type" style="width: 100%">
                        <option value="">Select</option>
                        <option value="Half-Yearly Examination-2022" <?php echo $row->exam_type === 'Half-Yearly Examination-2022' ? 'selected' : ''; ?>>Half-Yearly Examination-2022</option>
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" id="class_group" name="class_group" style="width: 100%">
                        <option value="">Select</option>
                        <option value="Science" <?php echo $row->class_group === 'Science' ? 'selected' : ''; ?>>Science</option>
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" id="course_name" name="course_name" style="width: 100%">
                        <option value="">Select</option>
                        <option value="Bangla I" <?php echo $row->course_name === 'Bangla I' ? 'selected' : ''; ?>>Bangla I</option>
                        <option value="Bangla II" <?php echo $row->course_name === 'Bangla II' ? 'selected' : ''; ?>>Bangla II</option>
                        <option value="English I" <?php echo $row->course_name === 'English I' ? 'selected' : ''; ?>>English I</option>
                        <option value="English II" <?php echo $row->course_name === 'English II' ? 'selected' : ''; ?>>English II</option>
                        <option value="Physics" <?php echo $row->course_name === 'Physics' ? 'selected' : ''; ?>>Physics</option>
                      </select>
                  ...
                  <div class="col-md-12">
                      ...
                      <table class="table items table-striped table-bordered table-condensed table-hover">
                        <tbody>
                          <tr>
                            <td>
                              <div class="form-group">
                                <input type="checkbox" name="is_subjective" id="is_subjective" value="1" class="minimal" <?php echo $row->is_subjective == 1 ? 'checked' : ''; ?>/>&nbsp;
                                <label for="subjective_mark">Subjective <span style="color: red;">*</span></label>

                                <input type="number" step="any" class="form-control" id="subjective_mark" name="subjective_mark" placeholder="Input" value="<?php echo $row->subjective_mark; ?>">
                            ...
                            <td>
                              <div class="form-group">
                                ...
                                <input type="number" step="any" class="form-control" id="subjective_pass_mark" name="subjective_pass_mark" placeholder="Input" value="<?php echo $row->subjective_pass_mark; ?>">
                          ...
                          <tr>
                            <td>
                              <div class="form-group">
                                <input type="checkbox" name="is_objective" id="is_objective" value="1" class="minimal" <?php echo $row->is_objective == 1 ? 'checked' : ''; ?>/>&nbsp;
                                <label for="objective_mark">Objective <span style="color: red;">*</span></label>

                                <input type="number" step="any" class="form-control" id="objective_mark" name="objective_mark" placeholder="Input" value="<?php echo $row->objective_mark; ?>">
                            ...
                            <td>
                              <div class="form-group">
                                ...
                                <input type="number" step="any" class="form-control" id="objective_pass_mark" name="objective_pass_mark" placeholder="Input" value="<?php echo $row->objective_pass_mark; ?>">
                          ...
                          <tr>
                            <td>
                              <div class="form-group">
                                <input type="checkbox" name="is_practical" id="is_practical" value="1" class="minimal" <?php echo $row->is_practical == 1 ? 'checked' : ''; ?>/>&nbsp;
                                <label for="practical_mark">Practical <span style="color: red;" class="practical_mark_span"></span></label>

                                <input type="number" step="any" class="form-control" id="practical_mark" name="practical_mark" placeholder="Input" value="<?php echo $row->practical_mark > 0 ? $row->practical_mark : ''; ?>">
                            ...
                            <td>
                              <div class="form-group">
                                ...
                                <input type="number" step="any" class="form-control" id="practical_pass_mark" name="practical_pass_mark" placeholder="Input" value="<?php echo $row->practical_pass_mark > 0 ? $row->practical_pass_mark : ''; ?>">
                          ...
                          <tr>
                            <td colspan="2">
                              <div class="form-group">
                                ...
                                <input type="number" step="any" class="form-control" id="total_mark" name="total_mark" placeholder="Input" value="<?php echo $row->total_mark; ?>">
                    ...
                    <div class="form-group">
                      <input type="checkbox" name="is_attendance" id="is_attendance" value="1" class="minimal" <?php echo $row->is_attendance == 1 ? 'checked' : ''; ?>/>&nbsp;
                      <label style="margin-right: 10px;">Attendance</label>

                      <input type="checkbox" name="is_status" id="is_status" value="1" class="minimal" <?php echo $row->is_status == 1 ? 'checked' : ''; ?>/>&nbsp;
                  ...
                  <div class="col-md-12">
                    <div class="box-footer" style="padding: 0;">
                      ...
                      <button type="submit" id="submit" class="button btn btn-info">
